    ...
    public function get(array $params = []): void
    {
        try {
            if (!$this->auth->isLogged()) {
                $msg = new Message("Veuillez vous connecter pour retirer de votre collection.", Message::COLOR_ERROR);
            ...
            $msg = new Message("Personnage retiré de votre collection.", Message::COLOR_INFO);
